"""hebb model — inspect and prefetch embedding models."""
...
def model_prefetch(model_id: str | None, region: str) -> None:
    ...
    if not config_path:
        raise click.ClickException("No hebb.json found. Run: hebb setup")
...
def _verify_model(model_id: str, hf_endpoint: str | None) -> int:
    ...
    asyncio.run(embedder.embed("hebb model prefetch verification"))
