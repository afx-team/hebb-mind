...
const translations = {
  en: {
    ...
    'settings.subtitle': 'Configuration from hippocampus.json',
  ...
  zh: {
    ...
    'settings.title': '设置',
    'settings.subtitle': '来自 hippocampus.json 的配置',
...
let currentLang = localStorage.getItem('hippocampus-lang') || 'en';
...
export function setLang(lang) {
  if (translations[lang]) {
    currentLang = lang;
    localStorage.setItem('hippocampus-lang', lang);
  }
}
