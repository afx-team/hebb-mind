"""hippocampus config — view and modify hippocampus.json."""
...
@click.group("config")
def config_cmd() -> None:
    """View and modify hippocampus.json configuration."""
    pass
...
def config_get(key: str) -> None:
    ...
    path = find_config_file()
    if not path:
        console.print("[red]No hippocampus.json found.[/]")
        raise SystemExit(1)
...
def config_set(key: str, value: str) -> None:
    """Set a configuration value in hippocampus.json.
...
def config_path() -> None:
    ...
    if path:
        ...
        console.print("[yellow]No hippocampus.json found.[/]")
        raise SystemExit(1)
