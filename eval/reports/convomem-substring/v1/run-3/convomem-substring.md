...
| Metric | Value |
|--------|-------|
| avg_evidence_recall | 0.712 |
| avg_top1_relevance | 0.324 |
| perfect_recall_rate | 0.708 |
| recall_abstention_evidence | 0.850 |
| recall_assistant_facts_evidence | 0.980 |
| recall_implicit_connection_evidence | 0.270 |
| recall_preference_evidence | 0.520 |
| recall_user_evidence | 0.940 |
| zero_recall_rate | 0.284 |
